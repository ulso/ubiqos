// The Adafruit Fruit Jam, as UbiqOS needs to know it.
//
...
#ifndef UBIQOS_BOARD_FRUIT_JAM_H
#define UBIQOS_BOARD_FRUIT_JAM_H

#define UBIQOS_BOARD_NAME   "Adafruit Fruit Jam"
...
#define UBIQOS_USB_HOST_DP          1
#define UBIQOS_HAS_USB_HOST_POWER   1
#define UBIQOS_USB_HOST_POWER       11       // switched, so a port can be cycled
...
#define UBIQOS_PERIPH_RESET     22
#define UBIQOS_ESP_BOOT_STRAP   0

// --- VIDEO -----------------------------------------------------------------
// DVI out of the HSTX peripheral: GP12 CKN, GP13 CKP, then D0, D1, D2 as N,P
// pairs, so one unbroken run.
#define UBIQOS_VIDEO_DVI_HSTX   1
#define UBIQOS_VIDEO_PIN_FIRST  12
#define UBIQOS_VIDEO_PIN_LAST   19

...
if(heap LESS MYRTOS_MIN_HEAP)
    message(FATAL_ERROR
        "SRAM is full: the C heap is ${heap} bytes, below the ${MYRTOS_MIN_HEAP} needed.\n"
        "  end          = ${heap_base}\n"
        ...
        "Make something smaller -- MYRTOS_HEAP_SIZE in kernel/main.c is the knob.")
endif()
